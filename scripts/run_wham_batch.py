...
Usage (in tmux):
    CUDA_VISIBLE_DEVICES=1 python scripts/run_wham_batch.py --start 0 --end 333 --gpu-id 1
    CUDA_VISIBLE_DEVICES=2 python scripts/run_wham_batch.py --start 333 --end 666 --gpu-id 2
    CUDA_VISIBLE_DEVICES=3 python scripts/run_wham_batch.py --start 666 --end 1000 --gpu-id 3
"""
